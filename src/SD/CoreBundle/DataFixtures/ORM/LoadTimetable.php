...
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-757')); $timetable->setName('Journée'); $timetable->setType('D'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-D-757', $timetable);
...
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-757')); $timetable->setName('Demi-journée'); $timetable->setType('HD'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-HD-757', $timetable);
...
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-507')); $timetable->setName('Ecole et Entraînements mercredi'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-212', $timetable);
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-507')); $timetable->setName('Ecole et Entraînements  jeudi'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-213', $timetable);
...
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-757')); $timetable->setName('Grille horaire'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-420', $timetable);
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-757')); $timetable->setName('Grille horaire mercredi'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-421', $timetable);
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-550')); $timetable->setName('Grille horaire Réunion/Atelier'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-422', $timetable);
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-507')); $timetable->setName('Ecole et Entraînements Samedi'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-428', $timetable);
$timetable = new Timetable($this->getReference('user-1'), $this->getReference('file-507')); $timetable->setName('Ecole et Entraînements vendredi'); $timetable->setType('T'); $manager->persist($timetable); $manager->flush(); $this->addReference('timetable-429', $timetable);
    }
