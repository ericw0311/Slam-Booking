...
$fileAdmin = new File($this->getReference('user-1022')); $fileAdmin->setName('Salle Multimédia'); $manager->persist($fileAdmin); $manager->flush(); $this->addReference('file-523', $fileAdmin);
...
$fileAdmin = new File($this->getReference('user-1519')); $fileAdmin->setName('Salle polyvalente'); $manager->persist($fileAdmin); $manager->flush(); $this->addReference('file-646', $fileAdmin);
